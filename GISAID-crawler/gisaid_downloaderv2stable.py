...
def find_date_intervals(driver, wait, initial_date, final_date):
    ...
    driver.find_element(By.XPATH,'//*[@id="ce_rtdch8_s_input"]').click()
    time.sleep(5)
    try:
        driver.execute_script("document.getElementById('sys_curtain').remove()")
        driver.execute_script("document.getElementById('sys_olcurtain').remove()")
    ...
    ActionChains(driver).move_to_element(datefield).click().send_keys(initial_date).perform()
    driver.find_element(By.XPATH,'//*[@id="ce_rtdch8_s_input"]').clear()
    driver.find_element(By.XPATH,'//*[@id="ce_rtdch8_s_input"]').send_keys(initial_date)
    time.sleep(wait)
    try:
        driver.execute_script("document.getElementById('sys_curtain').remove()")
        driver.execute_script("document.getElementById('sys_olcurtain').remove()")
    ...
    driver.find_element(By.XPATH,'//*[@id="ce_rtdch8_t_input"]').click()
    try:
        driver.execute_script("document.getElementById('sys_curtain').remove()")
        driver.execute_script("document.getElementById('sys_olcurtain').remove()")
    except:
    ...
    driver.find_element(By.XPATH,'//*[@id="ce_rtdch8_t_input"]').clear()
    driver.find_element(By.XPATH,'//*[@id="ce_rtdch8_t_input"]').send_keys(final_date)
...
def downloadFastaAndGoBack(driver):
    try:
        driver.execute_script("document.getElementById('sys_olcurtain').remove()")
        driver.execute_script("document.getElementById('sys_curtain').remove()")
    ...
    try:
        ...
        print("line 115")
    driver.find_element(By.XPATH,'/html/body/form/div[5]/div/div[2]/div/div[3]/div[2]/div/div[3]/div/button').click()
    # time.sleep(2)
    ...
    chooseField= driver.find_element(By.XPATH,"//input[@value='dna']")
    ...
    try:
        ...
        print("line 136")
    time.sleep(10)
    driver.find_element(By.XPATH,"//input[@value='dna']").click()
    ActionChains(driver).move_to_element(chooseField).click().perform()
...
def search_download_and_return_driver(driver, wait, initial_date, final_date):
...
time.sleep(10)
driver.execute_script("return sys.call('c_rtdch8_6ea','GoSearch',{});")
...
#set the arguments for the processing dates
    ...
    data_found= search_download_and_return_driver(driver, 2, initial_date, final_date)
